...
void AGameController::Tick(float DeltaTime)
{
				...
				if (PickupComponent->bDropStarted)
				{
								...
								PlayerController->GetMousePosition(XMousePosition, YMousePosition);
						
								FVector ObjectPosition = PickupComponent->ItemToInteract->GetActorLocation();

								FVector NewObjectPosition = FVector(XMousePosition, ObjectPosition.Y, YMousePosition);

								PickupComponent->ItemToInteract->SetActorRelativeLocation(NewObjectPosition);
				}
}
