...
#include "UForceBaseIndicatorArrow.generated.h"


/**
 * This class should demonstrate how you can create and use a ForceBaseIndicatorInterface in order to 
 * visualize the current force as an arrow.
 */
UCLASS()
class UREALISTICGRASPINGFORCEINDICATOR_API UForceBaseIndicatorArrow : public UObject, public IForceBaseIndicatorInterface
{
	GENERATED_BODY()
public:
